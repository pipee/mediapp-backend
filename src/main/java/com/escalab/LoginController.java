...
public class LoginController {
    ...
    public ResponseEntity<Integer> enviarCorreo(
        ...
        try{
            ...
            if (us != null && us.getIdUsuario() > 0){
                ...
                mail.setSubject("REESTABLECER CONSTRASEÑA - MEDIAPP");

                Map<String, Object> model = new HashMap<>();
                String url = "http://localhost:4200/recuperar/".concat(token.getToken());
    ...
    public ResponseEntity<Integer> restablecerClave(
